...
class Song_TableviewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        songList.append(kissMe)
        songList.append(kissMe2)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.artistLabel.text = songList[indexPath.row].artistName
        cell.albumImage.image = songList[indexPath.row].albumImage
        cell.albumLabel.text = songList[indexPath.row].albumName
